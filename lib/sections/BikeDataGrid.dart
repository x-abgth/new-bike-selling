...
import '../utils/BookingUrlFunc.dart';
import '../pages/HomePageRoutes/View-BookPage/ViewPage.dart';
...
class BikeDataGrid extends StatelessWidget {
          ...
          return Container(
            ...
            child: Column(
              children: [
                GestureDetector(
                  onTap: () {
                    navigateToView(index: index, snapshot: snapshot[index]);
                  },
                  child: Column(
  ...
  Future navigateToView({index, snapshot}) {
    return Get.to(ViewPage(index: index, snapshot: snapshot));
  }
}
